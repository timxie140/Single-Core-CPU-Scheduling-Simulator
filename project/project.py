...
with open('simout.txt', 'w') as file:
    ...
    if n < 0 or ncpu < 0 or alpha < 0:
        print("ERROR: Invalid input either number of processes(arg1), number of cpu-bound processes(arg2) or alpha number(arg7/range between 0 to 1) is negative please use non-negative integer", file=sys.stderr)
        sys.exit(1)
