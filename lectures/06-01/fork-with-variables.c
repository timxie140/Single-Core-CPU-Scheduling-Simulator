...
usleep( 50 );
   ...
   *  process, once in the CHILD process...
   */
  printf( "My PID is %d and I'm terminating...\n", getpid() );

  /* TO DO: What happens (memory?) if we move this free() call up
   *         into the if/else block above...?
   */
  free( z );
 ...
 * PARENT: x is now 125.                  CHILD: x is now 17.
 * My PID is ...                          My PID is ...
 *
