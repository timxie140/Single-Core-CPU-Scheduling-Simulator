...
int main()
{
   ...
   *  the stdout buffer contains "GOOD AFTERNOON\n" and
   *   this buffer gets copied to the child process
   *
   * Since we are in a block-based buffering mode, there
   *  are now only two possible outputs...
   */
